...
This brief course trains non-developers—Solution Architects, Project Managers, Business Analysts, and Admins—to become Apex-literate. 

Learners are not expected to write production-grade code. Instead, the course focuses on helping them understand Apex, recognize when it’s needed and highlight the structure of the clean code. Demonstrate how simple declarative changes can break poorly designed Apex.
